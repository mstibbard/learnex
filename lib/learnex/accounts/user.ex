defmodule Learnex.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Learnex.Repo)
  ...
  """
  def valid_password?(%Learnex.Accounts.User{hashed_password: hashed_password}, password)
